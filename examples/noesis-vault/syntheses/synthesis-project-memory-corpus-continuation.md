---
title: Project Memory Corpus Continuation Synthesis
noesis_id: synthesis-project-memory-corpus-continuation
type: synthesis
...
tags:
  ...
  - continuation
aliases:
  - project memory corpus continuation synthesis
---
...
The corpus should be realistic enough to brief future agents, but it should not
turn every raw capture into active context. Stale or superseded shortcuts remain
useful as traceable background when they explain why a safer reviewed path
exists.
